    ...
    it('invalid parameters with decimal values for numbers should give error', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    resp = _a.sent();
                    expect(resp).toEqual('Error: Expected positive integer for width but received 250.2 of type number');
                    return [2 /*return*/];
            }
        });
    }); });
    it('invalid parameter query with filename missing should give error', function () { return __awaiter(void 0, void 0, void 0, function () {
        var resp;
        return __generator(this, function (_a) {
            switch (_a.label) {
