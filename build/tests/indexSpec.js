...
it('test resizePic when all parameters exist and are valid types', function () {
    expect((0, imageResize_1.default)('fjord', 250, 380)).toBeTruthy(); //returned valid test even when I put fjord.jpg and file was not found, so this needs to change
});
it('test resizePic when all parameters exist and are valid types, including decimal number values', function () {
    expect((0, imageResize_1.default)('fjord', 250.2, 380.8)).toBeTruthy(); //returned valid test even when I put fjord.jpg and file was not found, so this needs to change
});
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, request.get("/images")];
            case 1:
                response = _a.sent();
